...
const initialState: CarImageActionState = { status: "idle", message: "" };
...
/** Form de foto del auto, reutilizado para "agregar" y para editar (ver CarImageRow). El orden se arrastra en la lista (ver CarImageManager). */
export function CarImageForm({
  action,
  image,
  submitLabel = "Agregar",
}: {
  action: (state: CarImageActionState, formData: FormData) => Promise<CarImageActionState>;
  image?: CarImage;
  submitLabel?: string;
}) {
