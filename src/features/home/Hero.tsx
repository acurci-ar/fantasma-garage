...
export function Hero({ settings }: { settings: SiteSettings }) {
  return (
    <section className="relative flex min-h-[92vh] items-center overflow-hidden bg-background pt-20">
      ...
      <div className="absolute inset-x-0 bottom-0 z-10 border-t border-secondary/20 bg-background/70 backdrop-blur-sm">
        <Container className="flex flex-wrap items-center justify-between gap-4 py-5 text-sm text-foreground/70">
          <span>
