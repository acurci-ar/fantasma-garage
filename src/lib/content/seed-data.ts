...
export const PROCESS_STEPS = [
  ...
  { key: "adaptaciones", title: "Adaptaciones", description: "Motores, transmisión, aire acondicionados, frenos, suspensión, etc." },
...
export const FEATURED_PRODUCTS: Product[] = [
  {
    ...
    seo_description: null,
    images: [
      { id: "img-1", product_id: "prod-1", url: "/images/productos/suspension.webp", thumb_url: null, alt: "Kit de suspensión clásica", position: 1 },
    ],
    variants: [],
  },
  {
    ...
    seo_description: null,
    images: [
      { id: "img-2", product_id: "prod-2", url: "/images/productos/motor.webp", thumb_url: null, alt: "Motor V8 reconstruido", position: 1 },
    ],
    variants: [],
  },
];
