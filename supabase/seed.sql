...
insert into public.services (slug, title, description, image_url, position, status) values
  ('restauracion-integral', 'Restauración integral', 'Recuperamos el vehículo completo, de chasis a terminación, con criterio de preservación histórica y nivel de colección.', '/images/galeria/trabajos.webp', 1, 'published'),
  ...
  ('proyectos-especiales', 'Proyectos especiales', 'Restomods y personalizaciones a medida, manteniendo el carácter original del vehículo.', '/images/galeria/detalles.webp', 5, 'published')
